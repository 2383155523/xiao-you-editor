...
<my-iframe src="https://fuyouplus.cn/" h="900px"></my-iframe>`),a=Z("light");y.on("theme",I=>{console.log(I),a.value=I});const g=[I=>{let i=I;const c=/ {0,3}\n*(`{3,}(?=[^`\n]*\n)|~{3,})([^\n]*)\n(?:|([\s\S]*?)\n)(?: {0,3}\1[~`]* *(?=\n|$)|$)/g;return c.test(I)&&(console.log("code"),i=I.replace(c,(...m)=>{var b;console.log(m);const M=m[2].trim();let d=(b=m[3])!=null?b:"";return d&&(d=d.replaceAll('"',"\u4EBB")),`<my-code lang="${M}" code="${d}"></my-code>`})),i}];return(I,i)=>{const c=z("xy-editor");return S(),D("div",j,[u(c,{modelValue:l.value,"onUpdate:modelValue":i[0]||(i[0]=m=>l.value=m),theme:a.value,"border-radius":"15px","font-family":"HarmonyOS_Sans_SC_Medium","custom-parser":g,templates:v(s),transitionMode:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)"},null,8,["modelValue","theme","templates"])])}}});var C=N(W,[["__scopeId","data-v-02ee4d82"]]);export{C as default};
